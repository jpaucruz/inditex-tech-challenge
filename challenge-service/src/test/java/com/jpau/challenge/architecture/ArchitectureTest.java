package com.jpau.challenge.architecture;
...
class ArchitectureTest {
    ...
    static final ArchRule input_ports_should_follow_the_project_convention =
            classes()
                    ...
                    .because(
                            "input ports represent capabilities offered by the application"
                    );
    ...
    static final ArchRule output_ports_should_follow_the_project_convention =
            classes()
                    ...
                    .because(
                            "output ports represent dependencies required by the application"
                    );
